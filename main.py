...
content.appendChild(wrap);
          ...
          // IMPORTANT: do not show result before wheel animation ends.
          // We keep the prize in state.rouletteWheel.prize as soon as the server responds,
          // but we only DISPLAY it when state.rouletteWheel.overlay===true.
          const _prizeRaw = state.rouletteWheel.prize;
          const showPrize = !!(state.rouletteWheel.overlay && _prizeRaw);
          const prize = showPrize ? _prizeRaw : null;
